...
export default ({
  ...
  const navLinks = [
    <NavLinks key={1}>
      <NavLink className="smoothscroll" href="/#features">Features</NavLink>
      <NavLink className="smoothscroll" href="#pricing">Pricing</NavLink>
      <NavLink className="smoothscroll" href="/#contactsales">Contact Sales</NavLink>
