...
const PrimaryButton = tw(PrimaryButtonBase)`mt-8 inline-block w-56 tracking-wide text-center py-5  bg-gradient-to-r from-primary-1000 to-secondary-1000 cursor-pointer`;
