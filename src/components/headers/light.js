...
import logo from "../../images/tpo_ai_logo.png";
...
export default ({ roundedHeaderButton = false, logoLink, links, className, collapseBreakpointClass = "lg" }) => {
  ...
  const defaultLogoLink = (
    <LogoLink href="/">
      <img style={{width:"380px",marginLeft:"-10px"}} src={logo} alt="logo" />
    </LogoLink>
  );
  ...
  return (
    <Header style={{marginTop:"-55px",marginLeft:"-55px"}} className={className || "header-light"}>
